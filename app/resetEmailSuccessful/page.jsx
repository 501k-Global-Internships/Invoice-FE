...
function ResetEmailSuccessful() {
  ...
  useEffect(() => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <p className="">sent to <span className="font-bold">{email}</span></p>
        <Link href='/resetPasswordEmail' className="mt-8 flex items-center gap-1 px-[6rem] py-2 bg-yellow-400 text-black rounded hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white">
          Resend Link 
          <svg
              width="14"
              height="8"
  ...
  export default ResetEmailSuccessful;
