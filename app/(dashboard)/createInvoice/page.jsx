...
const createInvoice = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/create-invoice", payload, {
        headers: {
  ...
  const draftInvoice = async (e) => {
    ...
    try {
      const response = await axios.post("/draft-invoice", payload, {
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + localStorage.getItem("token"),
        },
      ...
      <div className="h-full">
        <div className="flex flex-col lg:mt-[9rem] h-full p-8">
          ...
          <div className="mb-4">
            <Link
              href="/allInvoices"
              className="flex gap-2 items-center text-xl md:text-2xl"
            >
              <svg
                width="20"
                height="16"
          ...
          <div className="flex flex-col md:flex-row justify-between mb-7">
            <div className="w-full md:w-auto mt-[6rem]">
              <h3 className="text-xl">Invoice From</h3>
              <p className="text-gray-500">Enter your details as the sender</p>
            </div>
            {/* Dropzone component */}
            <div className="flex bg-gray-200 border-gray-400 border text-center rounded-md w-full md:w-1/3 mt-4 md:mt-0">
          ...
          <div className="shadow-xl border-t rounded-l ">
            <form onSubmit={handleSubmit} className="flex flex-col">
              <label
                htmlFor="name"
                className="block text-gray-700 mb-2 mt-4 ml-5 md:ml-8"
              >
                Name
              </label>
              <input
                ...
                className={`border rounded p-2 mb-4 ml-5 md:ml-8 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[38rem] focus:outline-none ${
                  errors.name ? "border-red-500" : ""
                }`}
              />
              <label htmlFor="email" className="mb-2 ml-5 md:ml-8">
                Email
              </label>
              <input
                type="email"
                ...
                className={`border rounded p-2 mb-4 ml-5 md:ml-8 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[50rem] focus:outline-none ${
          ...
          <div className="mt-[3rem]">
            ...
            <form
              ...
              className="flex flex-col space-y-4 border-t shadow-xl rounded-l p-4 md:p-8"
            >
              <label htmlFor="email" className="ml-5 md:ml-8">
                Customer's Name
              </label>
              <input
                type="text"
                ...
                className={`rounded p-2 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[38rem] ml-5 md:ml-8 border focus:outline-none ${
                  errors.customerName ? "border-red-500" : ""
                }`}
              />
              <label htmlFor="billingAddress" className="ml-5  md:ml-8 mt-3">
                Billing Address
              </label>
              <textarea
                id="billingAddress"
              ...
              />
              <label htmlFor="phoneNumber" className="block ml-5 md:ml-8">
                Telephone Number
              </label>
              <div
                className={`flex items-center border rounded p-2 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[50rem] ml-5 md:ml-8 ${
              ...
              <label htmlFor="email" className="w-[34rem] ml-5 md:ml-8">
                Email Address
              </label>
              <div
                className={`flex items-center border rounded p-2 w-[90%] sm:w-[80%] md:w-[70%] lg:w-[50rem] ml-5 md:ml-8 mb-9 ${
          ...
          <div className="shadow-xl border-t rounded-l p-4 md:p-9 mb-8">
            <div className="mb-[3.2rem] ">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (errors.invoiceTitle)
                    setErrors((prev) => ({ ...prev, invoiceTitle: false }));
                }}
                className={`shadow appearance-none w-[90%] sm:w-[80%] md:w-[70%] lg:w-[34rem] border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                  errors.invoiceTitle ? "border-red-500" : ""
                }`}
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (errors.paymentCurrency)
                    setErrors((prev) => ({ ...prev, paymentCurrency: false }));
                }}
                id="paymentCurrency"
                className={`shadow appearance-none w-[90%] sm:w-[80%] md:w-[70%] lg:w-[34rem] border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                  errors.paymentCurrency ? "border-red-500" : ""
                }`}
              >
            ...
            {items.map((item, index) => (
              <div className="flex mb-4" key={index}>
                ...
                <div className="hidden md:flex w-full">
                  <div className="mr-4 flex-1 md:w-1/3">
                    <label
                  ...
                  <div className="mr-4 flex-1 w-full sm:w-1/2 md:w-1/3">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="shadow appearance-none border rounded w-full md:w-[90%] lg:w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                placeholder="e.g Suite 10, Admiralty Way, Victoria Island, Lagos State, Nigeria"
              ></textarea>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap mb-2">
                <div className="flex items-center mr-4 flex-1 w-full sm:w-1/2 md:w-1/3">
                  <label
                    htmlFor="accountName"
                ...
                <div className="flex items-center flex-1 w-full sm:w-1/2 md:w-1/3">
                  <label
                    htmlFor="bankName"
                    className="block text-black mb-2 mr-2 whitespace-nowrap"
                  >
            ...
            <div className="flex flex-wrap sm:flex-row gap-4 sm:gap-8">
              <div className="w-full sm:w-auto">
                ...
                <input
                  ...
                  className={`appearance-none border-gray-300 border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full sm:w-auto ${
          ...
          <div className="bg-white shadow-xl border-solid rounded-l p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row justify-end mb-2 mr-4 md:mr-[.9rem]">
              ...
              <input
                ...
                placeholder="%"
                className={`w-full md:w-[8.6rem] mb-2 md:mb-0 md:mr-[2rem] border border-gray-300 text-end rounded-md px-2 py-1 focus:outline-none ${
            ...
            <hr className="mt-4 md:mt-[1.3rem] mb-4 md:mb-[1.3rem]" />
            <div className="flex justify-end text-black mr-4 md:mr-[.9rem]">
              <div className="flex items-center">
          ...
          <div className="flex flex-col sm:flex-row justify-between mt-[3rem] mb-[2rem]">
            <button
              onClick={draftInvoice}
              className="bg-white hover:bg-gray-400 text-black border-black border py-2 px-4 rounded-sm mb-4 sm:mb-0 sm:mr-2"
            >
              Save as draft
            </button>
            <button
