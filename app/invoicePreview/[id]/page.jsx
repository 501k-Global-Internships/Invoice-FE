...
const InvoicePreview = () => {
  ...
  const handleEditInvoice = async (e) => {
    ...
    try {
      const response = await axios.put(`edit-invoice/${id}`,
        payload, {
        headers: {
        ...
        <div>
          ...
          <div className="flex justify-between items-center mb-[3rem] mt-[1rem]">
            ...
            <div className="flex space-x-4">
              <div className="">
                <button onClick={handleEditButtonClick} className="flex gap-2 px-4 border border-gray-300 py-3 bg-white text-gray-800 rounded-md hover:bg-gray-300">
                  Edit invoice
                  <div>
                    <svg
                      width="24"
